...
var format_AlohaThreatZones_7 = new ol.format.GeoJSON();
var features_AlohaThreatZones_7 = format_AlohaThreatZones_7.readFeatures(json_AlohaThreatZones_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AlohaThreatZones_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AlohaThreatZones_7.addFeatures(features_AlohaThreatZones_7);
var lyr_AlohaThreatZones_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AlohaThreatZones_7, 
                style: style_AlohaThreatZones_7,
                popuplayertitle: "Aloha Threat Zones",
                interactive: true,
                title: 'Aloha Threat Zones'
            });
var format_AlohaPoints_8 = new ol.format.GeoJSON();
var features_AlohaPoints_8 = format_AlohaPoints_8.readFeatures(json_AlohaPoints_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AlohaPoints_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AlohaPoints_8.addFeatures(features_AlohaPoints_8);
var lyr_AlohaPoints_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AlohaPoints_8, 
                style: style_AlohaPoints_8,
                popuplayertitle: "Aloha Points",
                interactive: true,
                title: 'Aloha Points'
            });
var group_AR_Chlorine_N_22mph = new ol.layer.Group({
                                layers: [lyr_AlohaThreatZones_7,lyr_AlohaPoints_8,],
                                fold: "open",
                                title: "AR_Chlorine_N_22mph"});

lyr_GoogleSatellite_0.setVisible(true);lyr_amenity_school_bharuch_1.setVisible(true);lyr_landuse_residential_2.setVisible(true);lyr_feature_3.setVisible(true);lyr_landuse_farmland_4.setVisible(true);lyr_amenity_hospital_5.setVisible(true);lyr_landuse_industrial_6.setVisible(true);lyr_AlohaThreatZones_7.setVisible(true);lyr_AlohaPoints_8.setVisible(true);
...
lyr_AlohaThreatZones_7.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'MarplotID': 'MarplotID', });
lyr_AlohaPoints_8.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', 'MarplotID': 'MarplotID', });
...
lyr_AlohaThreatZones_7.set('fieldImages', {'Name': 'TextEdit', 'description': 'TextEdit', 'timestamp': 'DateTime', 'begin': 'DateTime', 'end': 'DateTime', 'altitudeMode': 'TextEdit', 'tessellate': 'Range', 'extrude': 'Range', 'visibility': 'Range', 'drawOrder': 'Range', 'icon': 'TextEdit', 'MarplotID': 'TextEdit', });
lyr_AlohaPoints_8.set('fieldImages', {'Name': '', 'description': '', 'timestamp': '', 'begin': '', 'end': '', 'altitudeMode': '', 'tessellate': '', 'extrude': '', 'visibility': '', 'drawOrder': '', 'icon': '', 'MarplotID': '', });
...
lyr_AlohaThreatZones_7.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'MarplotID': 'no label', });
lyr_AlohaPoints_8.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', 'MarplotID': 'no label', });
lyr_AlohaPoints_8.on('precompose', function(evt) {
